  ...
  public AccountDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfAccountEntity = new EntityInsertionAdapter<AccountEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `accounts` (`id`,`name`,`type`,`initialBalance`,`color`,`iconKey`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(6, entity.getIconKey());
    ...
    this.__updateAdapterOfAccountEntity = new EntityDeletionOrUpdateAdapter<AccountEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `accounts` SET `id` = ?,`name` = ?,`type` = ?,`initialBalance` = ?,`color` = ?,`iconKey` = ?,`createdAt` = ? WHERE `id` = ?";
      }
      ...
      public List<AccountEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new AccountEntity(_tmpId,_tmpName,_tmpType,_tmpInitialBalance,_tmpColor,_tmpIconKey,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public AccountEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new AccountEntity(_tmpId,_tmpName,_tmpType,_tmpInitialBalance,_tmpColor,_tmpIconKey,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
