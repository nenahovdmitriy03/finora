  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`type`,`iconKey`,`color`,`isDefault`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfCategoryEntity_1 = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `categories` (`id`,`name`,`type`,`iconKey`,`color`,`isDefault`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategoryEntity(_tmpId,_tmpName,_tmpType,_tmpIconKey,_tmpColor,_tmpIsDefault);
            _result.add(_item);
          }
          return _result;
        } finally {
